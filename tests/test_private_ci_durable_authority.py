...
class DurablePrivateCiAuthorityTests(unittest.TestCase):
    ...
    def test_mismatched_binding_does_not_consume_reservation(self):
        ...
        mismatch = valid_binding(repository="oimus1976/other-private", runner_scope_repository="oimus1976/other-private")
    ...
    def test_database_contains_no_registration_or_provider_credential_columns(self):
        ...
        try:
            ...
            connection.close()
        forbidden = {"credential", "credentials", "token_secret", "registration_token", "provider_token", "gh_token"}
