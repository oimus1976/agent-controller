...
from agent_controller.private_ci_phase6_result import (
    validate_phase6_result_authority,
)
from agent_controller.private_ci_phase7_result import (
    validate_phase7_result_authority,
)
...
def classify_final_private_ci_pilot(
    ...
    phase6 = validate_phase6_result_authority(phase6_result_bytes)
    phase7 = validate_phase7_result_authority(phase7_result_bytes)
