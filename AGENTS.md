...
- **No duplicate implementation.** While a provider's completed result may still be applied (for example Codex `View Task → Update branch`), do not reimplement it ([#200](https://github.com/oimus1976/agent-controller/issues/200)).
